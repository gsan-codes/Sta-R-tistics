...
# and iv) random slopes and random intercept model on the AD provided (https://www.kaggle.com/hyunseokc/detecting-early-alzheimer-s/data?select=oasis_cross-sectional.csv)
#
